...
namespace Osiris.Extensions.Exophase
{
    internal sealed class OsirisFooterUpdateProgress
    {
        ...
        public static OsirisFooterUpdateProgress TryStart(string title, string detail)
        {
        ...
        private void Invoke(string methodName, Type[] parameterTypes, params object[] arguments)
        {
            try
            {
                updateActionsType
            ...
            {
                // The bottom-panel surface is optional outside the Osiris theme.
            }
        }
    }
}
